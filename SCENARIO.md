# Feature request: As a user I want to have a new dog breed XXX to be processed by the application and the number of dogs adopted for this new breed to be visible in the output report.
