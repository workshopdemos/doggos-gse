...
npx zowe config set profiles.lpar1.profiles.test4z.properties.user "$USER_NAME"
npx zowe config set profiles.lpar1.profiles.test4z.properties.password "$USER_NAME"
npx zowe config set profiles.lpar1.profiles.zosmf.properties.user "$USER_NAME"
npx zowe config set profiles.lpar1.profiles.zosmf.properties.password "$USER_NAME"
printf "\n#########################################"
